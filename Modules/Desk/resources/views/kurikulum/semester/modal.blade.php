            ...
            <div class="modal-body" style="padding: 0;margin: 0;">
                ...
                <form id="formMain" class="row" method="post" action="javascript:onSaveIt('formMain')">
                    <div class="mb-4">
                        ...
                        <select class="form-select" id="tahun_pelajaran" name="tahun_pelajaran"></select>
                    </div>
                    <div class="mb-4">
                        <label class="form-label">Kurikulum</label>
                        <select class="form-select" id="kurikulum_id" name="kurikulum_id"></select>
                    </div>
                    <div class="mb-4">
                        <label class="form-label">Tingkat</label>
                        <select class="form-select" id="tingkat_id" name="tingkat_id"></select>
                    </div>
